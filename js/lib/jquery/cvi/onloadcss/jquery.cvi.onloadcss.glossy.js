		...
		if(image.width>=16 && image.height>=16) {
			...
			if(noshadow<1) {
				...
				shade = '<v:roundrect'+
							...
							' stroked="f"'+
							' fillcolor="#000000"'+
							' style="filter:Alpha(opacity=60), progid:dxImageTransform.Microsoft.Blur(PixelRadius=' + inset + ', MakeShadow=false);'+
							' zoom:1;margin:-1px 0 0 -1px;'+
							' padding: 0;'+
							' display:block;'+
							' position:absolute; top:' + inset + 'px;'+
							' left:0px;'+
							' width:' + (width-(2*inset)) + 'px;'+
							' height:' + (height-(3*inset)) + 'px;">'+
				...
				tmp = '<v:rect'+
							...
							' stroked="f"'+
							' fillcolor="#ffffff"'+
							' style="zoom:1;margin:-1px 0 0 -1px; padding: 0; display:block; position:absolute; top:0px; left:0px; width:' + width + 'px; height:' + height + 'px;">'+
								'<v:fill color="#ffffff" opacity="0.0" />'+
						'</v:rect>';
			}else {
			...
			'<v:fill method="sigma" type="gradient" angle="180" color="#000000" opacity="0.0" color2="#000000" o:opacity2="0.5" /></v:roundrect></v:group>';
