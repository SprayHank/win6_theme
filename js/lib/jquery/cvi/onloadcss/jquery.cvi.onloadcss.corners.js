...
function addIECorners() {
	...
	for (i=0;i<theimages.length;i++) {	
		...
		start = '<v:group'+
				' style="zoom:1; display:' + display + '; margin:-1px 0 0 -1px; padding:0; position:relative; width:' + width + 'px;height:' + height + 'px;"'+
		...
		if(iradius<=0) {
			if (ishadow>0) {
				if(inverse<=0) {
					...
					soft = '<v:rect'+
							...
							' stroked="f"'+
							' fillcolor="#ffffff"'+
							' style="position:absolute; margin:-1px 0 0 -1px;padding:0 ;width:' + width + 'px;height:' + height + 'px;">'+
							'<v:fill'+
							' color="#ffffff"'+
							' opacity="0.0" />'+
							'</v:rect>'+
							...
							' fillcolor="#000000"'+
							' style="'+
							'filter:Alpha(opacity=' + (ishadow*64) + '), progid:dxImageTransform.Microsoft.Blur(PixelRadius=' + inset + ', MakeShadow=false);'+
							'zoom:1;margin:-1px 0 0 -1px;padding:0;display:block;position:absolute;top:'+inset+'px;left:'+inset+'px;width:'+(width-(3*inset))+'px;height:'+(height-(3*inset))+'px;">'+
							'<v:fill'+
							' color="#000000"'+
							' opacity="1" />'+
							'</v:rect>';
					head = '<v:rect'+
							...
							' stroked="f"'+
							' fillcolor="#ffffff"'+
							' style="position:absolute; margin:-1px 0 0 -1px;padding:0 ;width:' + (width-offset) + 'px;height:' + (height-offset) + 'px;">';
				}else if(inverse>0) {
					...
					top = '<v:shape'+
							...
							' fillcolor="#000000"'+
							' coordorigin="0,0"'+
							' coordsize="' + width + ',' + iradius + '"'+
							' path="m 0,0 l '+width+',0,'+width+','+iradius+','+iradius+','+iradius+' x e"'+
							' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: 0px; width:' + width + 'px; height:' + iradius + 'px;">'+
							'<v:fill method="' + linear + '" type="gradient" angle="0" color="#000000" opacity="0" color2="#000000" o:opacity2="' + ishadow + '" />'+
							'</v:shape>'; 
					left = '<v:shape'+
							' strokeweight="0"'+
							' filled="t"'+
							...
							' fillcolor="#000000"'+
							' coordorigin="0,0"'+
							' coordsize="' + iradius + ',' + height + '"'+
							' path="m 0,0 l 0,'+height+','+iradius+','+height+','+iradius+','+iradius+' x e"'+
							' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: 0px; width:' + iradius + 'px; height:' + height + 'px;">'+
							'<v:fill'+
							' method="' + linear + '"'+
							' type="gradient"'+
							' angle="90"'+
							' color="#000000"'+
							' opacity="0"'+
							' color2="#000000" o:opacity2="' + ishadow + '" />'+
							'</v:shape>';
				}
			}else {
				head = '<v:rect'+
						...
						' stroked="f"'+
						' fillcolor="#ffffff"'+
						' style="margin:-1px 0 0 -1px;padding:0;display:' + display + ';width:' + width + 'px;height:' + height + 'px;">';
			}
			if(ishade>0) {
				...
				top = '<v:shape'+
						...
						' fillcolor="#ffffff"'+
						' coordorigin="0,0"'+
						' coordsize="' + (width-offset) + ',' + iradius + '"'+
						' path="m 0,0 l '+(width-offset)+',0,'+(width-offset)+','+iradius+','+iradius+','+iradius+' x e"'+
						' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: 0px; width:' + (width-offset) + 'px; height:' + iradius + 'px;">'+
						'<v:fill'+
						' method="linear"'+
						' type="gradient"'+
						' angle="0"'+
						' color="#ffffff"'+
						' opacity="0"'+
						' color2="#ffffff" o:opacity2="' + ishade + '" />'+
						'</v:shape>'; 
				left = '<v:shape'+
						' strokeweight="0"'+
						' filled="t"'+
						...
						' fillcolor="#ffffff"'+
						' coordorigin="0,0"'+
						' coordsize="' + iradius + ',' + (height-offset) + '"'+
						' path="m 0,0 l 0,'+(height-offset)+','+iradius+','+(height-offset)+','+iradius+','+iradius+' x e"'+
						' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: 0px; width:' + iradius + 'px; height:' + (height-offset) + 'px;">'+
						'<v:fill'+
						' method="linear"'+
						' type="gradient"'+
						' angle="90"'+
				...
				bottom = '<v:shape'+
						...
						' coordorigin="0,0"'+
						' coordsize="' + (width-offset) + ',' + iradius + '"'+
						' path="m 0,'+iradius+' l '+(width-offset)+','+iradius+','+(width-offset-iradius)+',0,'+iradius+',0 x e"'+
						' style="position:absolute; margin: 0; top:' + (height-offset-iradius) + 'px; left: 0px; width:' + (width-offset) + 'px; height:' + iradius + 'px;">'+
						'<v:fill'+
						' method="linear"'+
						' type="gradient"'+
						' angle="180"'+
						' color="#000000"'+
						' opacity="0"'+
						' color2="#000000" o:opacity2="' + ishade + '" />'+
						'</v:shape>';
				right = '<v:shape'+
						' strokeweight="0"'+
						' filled="t"'+
						...
						' coordorigin="0,0"'+
						' coordsize="' + iradius + ',' + (height-offset) + '"'+
						' path="m '+iradius+',0 l '+iradius+','+(height-offset)+',0,'+(height-offset-iradius)+',0,'+iradius+' x e"'+
						' style="position:absolute; margin: 0; top: 0px; left:' + (width-offset-iradius) + 'px; width:' + iradius + 'px; height:' + (height-offset) + 'px;">'+
						'<v:fill'+
						' method="linear"'+
						' type="gradient"'+
						' angle="270"'+
			...
			if(ishadow>0) {
				...
				if(inverse<=0) {
					...
					top = '<v:shape'+
							...
							' coordorigin="0,0"'+
							' coordsize="' + width + ',' + iradius + '"'+
							' path="m '+iradius+','+iradius+' l '+width+','+iradius+' qy '+(width-iradius)+',0 l '+iradius+',0 x e"'+
							' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: -1px; width:' + (width+1) + 'px; height:' + iradius + 'px;">'+
							'<v:fill'+
							' method="' + linear + '"'+
							' type="gradient"'+
							' angle="0"'+
					...
					left = '<v:shape'+
							...
							' coordorigin="0,0"'+
							' coordsize="' + iradius + ',' + height + '"'+
							' path="m 0,'+iradius+' l 0,'+(height-iradius)+' qy '+iradius+','+height+' l '+iradius+','+iradius+' x e"'+
							' style="position:absolute; margin: -1px 0 0 -1px; top: -1px; left: 0px; width:' + iradius + 'px; height:' + (height+1) + 'px;">'+
							'<v:fill'+
							' method="' + linear + '"'+
							' type="gradient"'+
							' angle="90"'+
					...
					lt = '<v:shape'+
							...
							' fillcolor="#000000"'+
							' coordorigin="0,0"'+
							' coordsize="' + iradius + ',' + iradius + '"'+
							' path="m '+iradius+','+iradius+' l 0,'+iradius+' qy '+iradius+',0 l '+iradius+','+iradius+' x e"'+
							' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: 0px; width:' + iradius + 'px; height:' + iradius + 'px;">'+
							'<v:fill'+
							' method="' + linear + '"'+
							' focus="1"'+
							' focusposition="1,1"'+
			...
			if(ishade>0) {
				...
				top = '<v:shape'+
						...
						' coordorigin="0,0"'+
						' coordsize="' + (width-offset) + ',' + iradius + '"'+
						' path="m '+iradius+','+iradius+' l '+(width-offset)+','+iradius+' qy '+(width-offset-iradius)+',0 l '+iradius+',0 x e"'+
						' style="position:absolute; margin: -1px 0 0 -1px; top: 0px; left: -1px; width:' + (width-offset+pos) + 'px; height:' + iradius + 'px;">'+
						'<v:fill'+
						' method="' + linear + '"'+
						' type="gradient"'+
						' angle="0"'+
				...
				left = '<v:shape'+
						...
						' coordorigin="0,0"'+
						' coordsize="' + iradius + ',' + (height-offset) + '"'+
						' path="m 0,'+iradius+' l 0,'+(height-iradius-offset)+' qy '+iradius+','+(height-offset)+' l '+iradius+','+iradius+' x e"'+
						' style="position:absolute; margin: -1px 0 0 -1px; top: -1px; left: 0px; width:' + iradius + 'px; height:' + (height-offset+pos) + 'px;">'+
						'<v:fill'+
						' method="' + linear + '"'+
						' type="gradient"'+
						' angle="90"'+
