...
var head = document.getElementsByTagName('HEAD')[0],
	headScript = head.getElementsByTagName('SCRIPT'),
	relativeJS = headScript[headScript.length - 1],
	path = relativeJS.src,
	libPath = window.libPath = path.substring(0, path.lastIndexOf('/')) + '/lib/';
...
m.define = f(3), u = o.createElement('script'), u.id = d + 'node';
